...
def batteries_check():
    try:
        print("Battery energy: {}%".format(battery))
    except NameError as e:
        raise RocketNotReadyError("Battery not found!") from e


def circuits_check():
    try:
        print("Circuit checking...")
        cc = 1 + 2 - 3 * "C"
    except TypeError as e:
        raise RocketNotReadyError("Bad Circuits!") from e
